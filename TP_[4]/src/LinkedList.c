...
static int addNode(LinkedList* this, int nodeIndex, void* pElement)
{
    ...
    if(this != NULL && nodeIndex >= 0 && nodeIndex <= ll_len(this) && (nuevoNodo = ll_newNode(pElement)) != NULL)
    {
    	if(nodeIndex == 0)
    	{
    	...
    	{
    		if((anterior = getNode(this, nodeIndex - 1)) != NULL)
    		{
